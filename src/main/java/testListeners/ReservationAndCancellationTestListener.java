...
public class ReservationAndCancellationTestListener implements ITestListener{
	...
	public void onTestSuccess(ITestResult result) {
		...
		try {
			TestReportFormatter.writeReport(result.getName(), result.getParameters().toString(), "PASSED", result.getThrowable().getMessage(), TestCase.RESERVATION_AND_CANCELLATION);
		} catch (Exception e) {
	...
	public void onTestFailure(ITestResult result) {
		...
		try {
			...
			TestReportFormatter.writeReport(result.getName(), result.getParameters().toString(), "FAILED", result.getThrowable().getMessage(), TestCase.RESERVATION_AND_CANCELLATION);
	...
	public void onStart(ITestContext context) {
		...
		try {
			TestReportFormatter.initialize(TestCase.RESERVATION_AND_CANCELLATION);
