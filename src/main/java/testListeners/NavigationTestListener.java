...
public class NavigationTestListener implements ITestListener,IInvokedMethodListener {
	...
	public void onTestStart(ITestResult result) {
		...
		try {
			TestReportFormatter.writeReport(result.getName(), result.getParameters().toString(), "PASSED", result.getThrowable().getMessage(), TestCase.SITE_NAVIAGTION);
		} catch (Exception e) {
	...
	public void onTestFailure(ITestResult result) {
		...
		try {
			...
			TestReportFormatter.writeReport(result.getName(), result.getParameters().toString(), "FAILED", result.getThrowable().getMessage(), TestCase.SITE_NAVIAGTION);
	...
	public void onStart(ITestContext context) {
		...
		try {
			TestReportFormatter.initialize(TestCase.SITE_NAVIAGTION);
	...
	public void onFinish(ITestContext context) {
		...
		for(String[] reports : report) {
			try {
				PostGreSQLHandler.pushReportToDB(reports, DataBaseTable.NAVIGATION_REPORT);
